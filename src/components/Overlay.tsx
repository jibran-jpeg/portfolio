...
export default function Overlay({ progress }: { progress?: MotionValue<number> }) {
    ...
    // Y Transforms (Parallax) — reduced on mobile for smoother feel
    ...
    return (
        <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center px-4 sm:px-6 md:px-24">
            ...
            >
                <h1 className="text-[2.5rem] leading-tight sm:text-5xl md:text-6xl lg:text-[5rem] font-black tracking-tighter text-white mb-3 sm:mb-6 drop-shadow-2xl">
                    Jibran <span className="opacity-80">Sarwar.</span>
                </h1>
                <div className="flex flex-wrap justify-center gap-1.5 sm:gap-2">
                    <span className="px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md text-[9px] sm:text-[10px] md:text-xs font-body tracking-[0.12em] sm:tracking-[0.15em] text-[#a0a0a0] uppercase">
            ...
            >
                <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-[3rem] font-semibold tracking-tight text-white max-w-2xl leading-[1.2] sm:leading-[1.15] drop-shadow-xl">
                    Building high-vibe digital products.
                </h2>
                <p className="mt-3 sm:mt-6 text-xs sm:text-base md:text-lg text-white/40 max-w-lg font-body font-light leading-relaxed">
