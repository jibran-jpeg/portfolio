...
export default function Home() {
  const [loadProgress, setLoadProgress] = useState({ loaded: 0, total: 237, done: false });
    ...
    <main className="min-h-screen bg-[#121212] selection:bg-white/30 selection:text-white">
      ...
      <div ref={heroRef} className="relative w-full">
        ...
        <div className="absolute top-0 left-0 right-0 h-full pointer-events-none">
          <div className="sticky top-0 h-[100dvh] w-full overflow-hidden z-10 flex flex-col justify-center">
